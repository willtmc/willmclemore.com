...
export const metadata: Metadata = {
  title: 'Will McLemore - Auction Industry Expert & Technology Leader',
  description: 'Turn bidders into buyers with AI-driven auction strategy. CEO of Gavel, Yale graduate, and auction technology innovator helping owners achieve faster sales and higher prices.',
  keywords: [
    'Will McLemore',
    'auction technology',
    'auction strategy',
  ...
  openGraph: {
    title: 'Will McLemore - Auction Industry Expert & Technology Leader',
    description: 'Turn bidders into buyers with AI-driven auction strategy. CEO of Gavel, Yale graduate, and auction technology innovator.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Will McLemore - Auction Industry Expert'
      }
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Will McLemore - Auction Industry Expert & Technology Leader',
    description: 'Turn bidders into buyers with AI-driven auction strategy. CEO of Gavel and auction technology innovator.',
    images: ['/opengraph-image'],
  },
  alternates: {
    canonical: 'https://willmclemore.com',
  },
}
...
export default function HomePage() {
  const jsonLd = {
    ...
    sameAs: [
      ...
      'https://twitter.com/willmclemore',
    ],
    knowsAbout: [
      'Auction Technology',
    ...
    description: 'Auction industry expert and technology leader specializing in AI-driven auction strategies.'
  }
